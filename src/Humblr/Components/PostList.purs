...
type State g = ParentState PostListState PostState PostListQuery PostQuery g PostSlot
type Query = Coproduct PostListQuery (ChildF PostSlot PostQuery)

postListComponent :: forall g. Functor g => Component (State g) Query g
